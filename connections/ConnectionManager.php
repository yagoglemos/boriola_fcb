...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "columbofilia_at_localhost";
		$data["connName"] = "columbofilia at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;columbofilia;;1"; //currently unused

		$this->_connectionsIdByName["columbofilia at localhost"] = "columbofilia_at_localhost";
		...
		$connectionsData["columbofilia_at_localhost"] = $data;
