...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "columbofilia_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["anilha"] = "columbofilia_at_localhost";
		$connectionsIds["clube"] = "columbofilia_at_localhost";
		$connectionsIds["federacao"] = "columbofilia_at_localhost";
		$connectionsIds["pombo"] = "columbofilia_at_localhost";
		$connectionsIds["socio"] = "columbofilia_at_localhost";
		$connectionsIds["vanilhas"] = "columbofilia_at_localhost";
		$connectionsIds["anilhas"] = "columbofilia_at_localhost";
