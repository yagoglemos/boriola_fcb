...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("anilha" == $this->chrt_array['tables'][0])
			return true;
		if("clube" == $this->chrt_array['tables'][0])
			return true;
		if("federacao" == $this->chrt_array['tables'][0])
			return true;
		if("pombo" == $this->chrt_array['tables'][0])
			return true;
		if("socio" == $this->chrt_array['tables'][0])
			return true;
		if("vanilhas" == $this->chrt_array['tables'][0])
			return true;
		if("anilhas" == $this->chrt_array['tables'][0])
			return true;
		if("pedigree" == $this->chrt_array['tables'][0])
			return true;
		if("cores" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
