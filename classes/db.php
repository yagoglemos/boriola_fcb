...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "columbofilia_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "anilha", "varname" => "columbofilia_at_localhost__anilha", "altvarname" => "anilha", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "anilhas", "varname" => "columbofilia_at_localhost__anilhas", "altvarname" => "anilhas", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "clube", "varname" => "columbofilia_at_localhost__clube", "altvarname" => "clube", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "columbofilia_settings", "varname" => "columbofilia_at_localhost__columbofilia_settings", "altvarname" => "columbofilia_settings", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "cores", "varname" => "columbofilia_at_localhost__cores", "altvarname" => "cores", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "federacao", "varname" => "columbofilia_at_localhost__federacao", "altvarname" => "federacao", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedigree", "varname" => "columbofilia_at_localhost__pedigree", "altvarname" => "pedigree", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "pombo", "varname" => "columbofilia_at_localhost__pombo", "altvarname" => "pombo", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "socio", "varname" => "columbofilia_at_localhost__socio", "altvarname" => "socio", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
			$dalTables[$conn->connId][] = array("name" => "vanilhas", "varname" => "columbofilia_at_localhost__vanilhas", "altvarname" => "vanilhas", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		}
	}
