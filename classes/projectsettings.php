...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "columbofilia_at_localhost";
		}
		return $connId;
	}
...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("socio", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "anilha" ] = array( "url" => "anilha", "type" => 0 );
	$projectEntitiesReverse[ "anilha" ] = "anilha";
	$projectEntities[ "clube" ] = array( "url" => "clube", "type" => 0 );
	$projectEntitiesReverse[ "clube" ] = "clube";
	$projectEntities[ "federacao" ] = array( "url" => "federacao", "type" => 0 );
	$projectEntitiesReverse[ "federacao" ] = "federacao";
	$projectEntities[ "pombo" ] = array( "url" => "pombo", "type" => 0 );
	$projectEntitiesReverse[ "pombo" ] = "pombo";
	$projectEntities[ "socio" ] = array( "url" => "socio", "type" => 0 );
	$projectEntitiesReverse[ "socio" ] = "socio";
	$projectEntities[ "vanilhas" ] = array( "url" => "vanilhas", "type" => 0 );
	$projectEntitiesReverse[ "vanilhas" ] = "vanilhas";
	$projectEntities[ "anilhas" ] = array( "url" => "anilhas", "type" => 0 );
	$projectEntitiesReverse[ "anilhas" ] = "anilhas";
	$projectEntities[ "pedigree" ] = array( "url" => "pedigree", "type" => 0 );
	$projectEntitiesReverse[ "pedigree" ] = "pedigree";
	$projectEntities[ "cores" ] = array( "url" => "cores", "type" => 0 );
	$projectEntitiesReverse[ "cores" ] = "cores";
}
