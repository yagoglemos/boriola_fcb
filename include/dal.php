...
class tDAL
{
	var $tblcolumbofilia_at_localhost__anilha;
	var $tblcolumbofilia_at_localhost__anilhas;
	var $tblcolumbofilia_at_localhost__clube;
	var $tblcolumbofilia_at_localhost__columbofilia_settings;
	var $tblcolumbofilia_at_localhost__cores;
	var $tblcolumbofilia_at_localhost__federacao;
	var $tblcolumbofilia_at_localhost__pedigree;
	var $tblcolumbofilia_at_localhost__pombo;
	var $tblcolumbofilia_at_localhost__socio;
	var $tblcolumbofilia_at_localhost__vanilhas;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "anilha", "varname" => "columbofilia_at_localhost__anilha", "altvarname" => "anilha", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "anilhas", "varname" => "columbofilia_at_localhost__anilhas", "altvarname" => "anilhas", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "clube", "varname" => "columbofilia_at_localhost__clube", "altvarname" => "clube", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "columbofilia_settings", "varname" => "columbofilia_at_localhost__columbofilia_settings", "altvarname" => "columbofilia_settings", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "cores", "varname" => "columbofilia_at_localhost__cores", "altvarname" => "cores", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "federacao", "varname" => "columbofilia_at_localhost__federacao", "altvarname" => "federacao", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "pedigree", "varname" => "columbofilia_at_localhost__pedigree", "altvarname" => "pedigree", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "pombo", "varname" => "columbofilia_at_localhost__pombo", "altvarname" => "pombo", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "socio", "varname" => "columbofilia_at_localhost__socio", "altvarname" => "socio", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
		$this->lstTables[] = array("name" => "vanilhas", "varname" => "columbofilia_at_localhost__vanilhas", "altvarname" => "vanilhas", "connId" => "columbofilia_at_localhost", "schema" => "", "connName" => "columbofilia at localhost");
	}
